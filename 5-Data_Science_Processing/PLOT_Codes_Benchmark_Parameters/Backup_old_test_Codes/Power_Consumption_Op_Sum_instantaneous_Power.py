...
filtered_real_car_journey = df_synchronize_yaw_to_current_pose_velocity[df_abs_difference>0.000000000005]
...
df_vel = filtered_real_car_journey[['%time_x', 'field.twist.linear.x','field.twist.angular.z']]
