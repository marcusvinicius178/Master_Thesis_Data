...
df_vel = pd.read_csv(r'current_velocity_lattice.csv')
df_pose = pd.read_csv(r'current_pose_lattice.csv')
df_yaw_angle = pd.read_csv(r'lattice_converted_quaternions_to_Euler.csv')
...
Power_Consumption_Lattice_Planner = Power_Consumption_watts/ 745.699872
...
#FINALLY THE OPPOSITE FORCES (DRAG AND FRICTION) MUST BE ADDED - SUBTRACTED FROM FIRST CALCULATED