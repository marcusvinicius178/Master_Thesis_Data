...
ax = Op.heading_deviation_autoware_column_rename_h.plot(kind='line', x='Path Position', y= Op.planner_name, linewidth=1, color= 'Green', legend=True, ax=axes[1])
Astar.heading_deviation_autoware_column_rename_h.plot(ax= ax, kind='line', x='Path Position', linewidth=2, color= 'Black', legend=True)
