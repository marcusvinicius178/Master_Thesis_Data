...
#print(b.topic_table)
bag = rosbag.Bag('New_Freespace_Astar_No_collision.bag')
topic_pose = '/odom' #'localizer_pose' = 25 messages synchronized with final_waypoints
#current pose synchronizes 34 messages with final_Waypoints data
#Odometry synchronizes 35 messages with final_waypoints data
...
df.to_csv('Astar_current_pose_for_Deviation_calc.csv')
