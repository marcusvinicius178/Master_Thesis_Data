...
Ft_Value_Average = M * (linear_accel_xy_average + Total_Accel_Lin_Rot_Median)
...
Vrot_linear_x_component_average =  (np.nansum(Vrot_linear_x_component_mask)) / len(Vrot_linear_x_component_mask)
Vrot_linear_y_component_average = (np.nansum(Vrot_linear_y_component_mask)) / len(Vrot_linear_y_component_mask)
